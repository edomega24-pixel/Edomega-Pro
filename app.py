...
def registrar_sinergia(precio, tendencia, vol, vol_avg):
    data = {
...
if df is not None:
    ...
    if es_sinergia and last_vol > vol_avg:
        ...
        registrar_sinergia(last_close, trend_5m, last_vol, vol_avg)
    ...
    st.write(f"Precio: {last_close:.2f} | EMA 200: {ema200:.2f} | Volumen: {last_vol:.0f} (Promedio: {vol_avg:.0f})")
else:
