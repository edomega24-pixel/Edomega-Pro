...
def agregar_al_historial(tipo):
    ...
    # Mantener solo las últimas 24 entradas (asumiendo chequeos frecuentes)
    if len(st.session_state.historial) > 24:
        st.session_state.historial.pop(0)

st.title("OMEGA PRO: Motor con Historial")
...
# Lógica de estados
nuevo_status = st.session_state.last_status
...
if st.session_state.historial:
    ...
    st.write("Esperando a que ocurra la primera señal...")
